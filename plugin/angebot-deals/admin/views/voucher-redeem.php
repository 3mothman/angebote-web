...
<div class="wrap angebot-admin-vouchers">
    <h1><?php esc_html_e('Gutscheine einlösen', 'angebot-deals'); ?></h1>

    <div class="angebot-admin-lookup card" style="max-width:640px;padding:16px;margin:16px 0">
        <h2><?php esc_html_e('Code prüfen', 'angebot-deals'); ?></h2>
        <p>
            <input type="text" id="angebot-admin-code" class="regular-text" placeholder="XXXX-XXXX-XXXX">
            <button type="button" class="button button-primary" id="angebot-admin-lookup-btn"><?php esc_html_e('Prüfen', 'angebot-deals'); ?></button>
            <button type="button" class="button" id="angebot-admin-redeem-btn" disabled><?php esc_html_e('Einlösen', 'angebot-deals'); ?></button>
        </p>
    ...
    <form method="get">
        ...
        <p class="search-box">
            <label class="screen-reader-text" for="voucher-search"><?php esc_html_e('Suchen', 'angebot-deals'); ?></label>
            <input type="search" id="voucher-search" name="s" value="<?php echo esc_attr($search); ?>">
            <select name="status">
                <option value=""><?php esc_html_e('Alle Status', 'angebot-deals'); ?></option>
            ...
            <?php submit_button(__('Filtern', 'angebot-deals'), '', '', false); ?>
        </p>
    </form>
    ...
    <table class="wp-list-table widefat fixed striped">
        <thead>
            <tr>
                ...
                <th><?php esc_html_e('Kunde', 'angebot-deals'); ?></th>
                <th><?php esc_html_e('Status', 'angebot-deals'); ?></th>
                <th><?php esc_html_e('Ablauf', 'angebot-deals'); ?></th>
                <th><?php esc_html_e('Bestellung', 'angebot-deals'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if (!$vouchers) : ?>
                <tr><td colspan="6"><?php esc_html_e('Keine Gutscheine.', 'angebot-deals'); ?></td></tr>
